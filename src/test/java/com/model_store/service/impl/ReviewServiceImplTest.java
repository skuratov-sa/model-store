...
class ReviewServiceImplTest {
    ...
    void addReview_shouldSaveReview_whenOrderExistsAndNoExistingReview() {
        ...
        verify(reviewMapper).toReview(reviewRequestDto, order1);
    ...
    void getReviewsForSeller_shouldReturnFluxOfReviewResponseDto_whenReviewsExist() {
        ...
        when(reviewMapper.toReviewResponseDto(review1, reviewerName)).thenReturn(reviewResponseDto);
        ...
        verify(reviewMapper).toReviewResponseDto(review1, reviewerName);
    }
    ...
    void getReviewsForSeller_shouldReturnEmptyFlux_whenNoReviewsExistForSeller() {
        ...
        verify(reviewMapper, never()).toReviewResponseDto(any(Review.class), anyString());
    }
